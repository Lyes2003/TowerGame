...
public class TourEmplacement extends Tour {
    ...
    static {
       ...
       tours[ 1 ] = new DescripteurTour( "feu", 10, TourDeFeu::new, Constantes.POSITION_ACHAT_TOUR_Y + 2 );
       tours[ 2 ] = new DescripteurTour("glace", 10, TourDeGlace::new, Constantes.POSITION_ACHAT_TOUR_Y + 4);
    }
