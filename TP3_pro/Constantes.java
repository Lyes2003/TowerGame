...
public class Constantes {
    ...
    public static  Tuile E_LAPIN = new Tuile( new Color( 200, 105, 10 ), BitMap.LAPIN );
    public static  Tuile E_TORTUE = new Tuile( new Color( 100, 130, 32 ), BitMap.TORTUE );
    public static  Tuile E_BOSS = new Tuile( new Color( 150, 105, 10 ), BitMap.BOSS );
    // tuile pour les ennemis enflammé
    public static final Tuile E_LAPIN_EN_FLAMME = new Tuile(new Color(255, 0, 0), BitMap.LAPIN);
    public static final Tuile E_TORTUE_EN_FLAMME = new Tuile(new Color(255, 0, 0), BitMap.TORTUE);
    public static final Tuile E_BOSS_EN_FLAMME = new Tuile(new Color(255, 0, 0), BitMap.BOSS);
    // tuile pour les ennemis gelé
    public static final Tuile E_LAPIN_GLACE = new Tuile(new Color(0, 0, 255), BitMap.LAPIN);
    public static final Tuile E_TORTUE_GLACE = new Tuile(new Color(0, 0, 255), BitMap.TORTUE);
    public static final Tuile E_BOSS_GLACE = new Tuile(new Color(0, 0, 255), BitMap.BOSS);
    //tuile pour les ennemis enflammé et gelé
    public static final Tuile E_LAPIN_EN_FLAMME_ET_EN_GLACE = new Tuile(new Color(238, 130, 238), BitMap.LAPIN);
    public static final Tuile E_TORTUE_EN_FLAMME_ET_EN_GLACE = new Tuile(new Color(238, 130, 238), BitMap.TORTUE);
    public static final Tuile E_BOSS_EN_FLAMME_ET_EN_GLACE = new Tuile(new Color(238, 130, 238), BitMap.BOSS);
