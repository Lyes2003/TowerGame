...
public class NiveauTD_1 implements Niveau {
    public static final int ARGENT_DEPART = 1000000;
    ...
    public static  Ennemi LAPIN = new Ennemi( NiveauTD_1.CHEMIN, 0.8, 10, 10, Constantes.E_LAPIN , 1);
    public static  Ennemi TORTUE = new Ennemi( NiveauTD_1.CHEMIN, 1.5, 4, 10, Constantes.E_TORTUE, 2);
    public static  Ennemi BOSS = new Ennemi( NiveauTD_1.CHEMIN, 0.5, 100, 100,Constantes.E_BOSS, 3);
